...
('cs', 'gallery', 'hero', 'Momenty v obrazech', 'Koncerty, svatby a akce s atmosférou.', '', '', '', '', 10),
('en', 'gallery', 'hero', 'Moments in pictures', 'Concerts, weddings and events with atmosphere.', '', '', '', '', 10),
('cs', 'videos', 'hero', 'Poslouchejte Fourhands', 'Výběr koncertních vystoupení a hudebních ukázek.', '', '', '', '', 10),
('en', 'videos', 'hero', 'Listen to Fourhands', 'Selection of concert performances and music samples.', '', '', '', '', 10),
