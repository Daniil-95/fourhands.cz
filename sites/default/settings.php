 ...
 * @endcode
 */
$settings['hash_salt'] = '0-OfU-lFUvpHaO94a2jr4VkRHRXBmpRCXdXKkkQh1RmDbjEUGhgBhS7ve4lu7c9Hq-5EILSQQw';
...
$databases['default']['default'] = array (
  'database' => 'fourhandscz',
  'username' => 'fourhandscz001',
  'password' => '4Ew5atFp',
  'prefix' => 'drupal953_',
  'host' => '127.0.0.1',
  'port' => '3306',
...
$settings['config_sync_directory'] = 'sites/default/files/config_d3gz86TGuXky8hI61vXqKSNFi-Q_2moOFGsbfPHhkSDvF5LttXH8IrERQHicGrYHbLoRYq1kNA/sync';

$settings['trusted_host_patterns'] = [
  '^fourhands.cz$',
  '^.+\.fourhands.cz$',
];
$config['system.file']['path']['temporary'] = '/home/www/fourhands.cz/www/fourhands.cz/tmp';
